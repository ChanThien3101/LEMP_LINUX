                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material" enctype="multipart/form-data" action="<?php echo BASE_URL?>/product/insert_category" method="post">
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Category Name</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="Samsung"
                                                class="form-control p-0 border-0" name="title_category_product"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Category Descriptionn</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <textarea id="editor" rows="5" class="form-control p-0 border-0" name="desc_category_product"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
