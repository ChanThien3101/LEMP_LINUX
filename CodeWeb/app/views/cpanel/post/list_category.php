         ...
         <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h2 class="box-title">News List Table</h2>
                            <h3><a class="fas fa-hand-point-right" href="<?php echo BASE_URL?>/post/add_category"> Add Post Category</a></h3>
                                    ...
                                    <tbody>
                                     <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo BASE_URL?>/post/edit_category/<?php echo $cate['id_category_post']?>">Edit</a> ~ 
                                                <a href="<?php echo BASE_URL?>/post/delete_category/<?php echo $cate['id_category_post']?>">Delete</a>
                                            </td>
                                        </tr>
                                           <?php 
                                }
