               ...
               <div class="content_text">
				<div class="container_table">
					<table class="table table-hover table-condensed">
						...
						<tbody>
                           <?php
                        if (isset($_SESSION['shopping_cart']) && isset($_SESSION['customerdn'])) {
                          
                            ?>
                           <form
								action="<?php echo BASE_URL ?>/giohang/updategiohang"
								method="POST">
                               <?php
                            $total = 0;
                            foreach ($_SESSION['shopping_cart'] as $key => $value) {
                                if ($_SESSION['shopping_cart'][$key]['customer_id'] == $_SESSION['customer_id']) {
                         ...
                         <?php   
                           ...
                           <tr>
								<td colspan="7">
									<div class="sum_price_all">
										<span class="text_price">Giỏ hàng</span> <span
						...
						<div class="ch-contacts-details">
							<ul class="contact-list">
								<li class="addr"><strong class="title">Địa chỉ của chúng tôi</strong>
									<p>
										<em><strong>VKU_SmartTech</strong></em><br />
									...
									<p>Hotline: 0399819699 (zalo)</p>
									</p></li>
							</ul>
							<div class="hiring-box">
								<strong class="title">Chào bạn!</strong>
								<p>
									Mọi thắc mắc bạn hãy gửi về mail của chúng tôi <strong>dhduc.20it5@vku.udn.vn
										<br>
									</strong> chúng tôi sẽ giải đáp cho bạn.
								</p>
								<p>
									<a href="." class="arrow-link"><i class="fa fa-long-arrow-left"
										...
										<div class="row">
											<div class="input">
												...
												<input type="text" name="sodienthoai"
													value="<?php echo $infor['customers_phone']?>" readonly
													required onkeydown="return checkIt(event)" class="clsip">
											</div>
											<div class="clear"></div>
										</div>
										<!---row---->
										<div class="row">
											<div class="input">
												<label>Địa chỉ: <span style="color: red;">*</span></label> <input
													...
													value="<?php echo $infor['customers_address']?>" readonly
													required class="clsip">
											</div>
											<div class="clear"></div>
										</div>
										...
										<div class="row">
											<div class="input">
												<label>Email: <span style="color: red;">*</span></label> <input
													...
													onchange="return KiemTraEmail(this);" required
													class="clsip">
											</div>
											<div class="clear"></div>
										</div>
										...
										<div class="row btnclass">
											<div class="input ipmaxn ">
												<input type="submit" class="btn-gui" name="frmSubmit"
													id="frmSubmit" value="Gửi đơn hàng"> <input type="reset"
