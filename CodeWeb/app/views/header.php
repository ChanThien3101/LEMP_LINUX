						...
						<nav class="menu_top">
							<form class="search_form" method="get" action="<?php echo BASE_URL?>/sanpham/timkiem">
								<input class="searchTerm" name="content"
									placeholder="Nhập từ cần tìm..." required="required" />
						...
						<div class="cart_wrapper">
							<div class="cols_50">
								<div class="hot_line_top">
									<span><b>Trụ sở chính</b></span> <br /> <span class="red">VKU University</span>
								</div>
							</div>
							<div class="cols_50">
								<div class="hot_line_top">
									<span><b>Văn phòng</b></span> <br /> <span
						...
						<div class="menu_top_cate">
							<div class="">
								<div class="menu" id="menu_cate">
									<div class="menu_left">
										<i class="fa fa-bars" aria-hidden="true"></i> Danh mục sản
										phẩm
									</div>
									<div class="cate_pro">
						...
						<div class="search_top">
							<div id='cssmenu'>
								<ul>
									...
									<li class=''><a href='<?php echo BASE_URL?>/contact/gioithieu'>Giới
											thiệu</a></li>
									<li class=''><a href='<?php echo BASE_URL?>/sanpham/tatca'>Sản
											phẩm</a>
										<ul>
										 <?php
                                            foreach ($category as $key => $cate) {
                                ...
                                foreach ($category_post as $key => $cate_post) {
									...
									<li class=''><a href='<?php echo BASE_URL?>/giohang'>Giỏ hàng</a>
									<ul>
									<li class="active has-sub"><a href='<?php echo BASE_URL?>/giohang'>Giỏ Hàng</a></li>
									 <li class="active has-sub"><a href='<?php echo BASE_URL?>/donhang/donhang/<?php echo $_SESSION['customer_phone']?>'>Đơn Hàng</a></li>
									</ul>
									</li>
									<li class=''><a href='<?php echo BASE_URL?>/contact/lienhe'>Liên
											hệ</a></li>

									<li class=''><a href='<?php echo BASE_URL?>'>Tài Khoản</a>
										<ul>
                                									<?php
                                        if (Session::get('customerdn')) {
                                            ?>
									    <li class="active has-sub"><a
												href='<?php echo BASE_URL?>/khachhang/hoso'>Hồ Sơ</a></li>
									    <li class="active has-sub"><a
												href='<?php echo BASE_URL?>/khachhang/dangxuat'>Đăng Xuất</a></li>
									    <?php
        } else {
            ?>
									    <li class=''><a
												href='<?php echo BASE_URL?>/khachhang/dangnhap'>Đăng Nhập</a></li>
											<li class=''><a
												href='<?php echo BASE_URL?>/khachhang/dangnhap'>Đăng Ký</a></li>
									    <?php
        }
        ?>
